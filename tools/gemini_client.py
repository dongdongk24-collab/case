...
📌 출처 명시 원칙 (반드시 준수):
- 출처는 반드시 해당 서비스의 실제 안내/신청 페이지 URL을 명시 (홈페이지 메인 X)
  예시: https://www.bokjiro.go.kr/ssis-tbu/twataa/wlfareInfo/moveTWAT52011M.do?wlfareInfoId=WLF00000621 (기초생활보장)
- 복지로 서비스 검색: https://www.bokjiro.go.kr 에서 서비스명으로 검색하여 정확한 URL 제공
- 출처가 불명확한 경우: "⚠️ 출처 미확인" 명시
